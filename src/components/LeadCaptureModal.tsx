    ...
    >
      ...
      <div className="relative z-10 flex w-full max-w-4xl max-h-[92vh] flex-col overflow-hidden rounded-2xl bg-white shadow-2xl sm:flex-row">
        <button
          type="button"
          onClick={closeModal}
          className="absolute right-3 top-3 z-20 rounded-full p-1.5 text-gray-700 transition-colors hover:bg-gray-100 hover:text-gray-900"
          aria-label="Close"
        >
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-y-auto">
          ...
          <div className="mb-5 pr-8 sm:mb-6">
            <h2
              id="lead-modal-title"
              className="text-xl font-bold leading-snug text-[#0d7a72] sm:text-2xl"
            >
              Looking for Your Next Adventure?
            </h2>
            <p className="mt-2 text-sm leading-relaxed text-gray-500 sm:text-[0.95rem]">
          ...
          {submitted ? (
            <div className="flex flex-1 flex-col items-center justify-center py-8 text-center">
              <p className="text-lg font-semibold text-[#0d7a72]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="lead-name" className="mb-1.5 block text-sm font-medium text-gray-800">
                  Name
                </label>
                <input
                  id="lead-name"
                  ...
                  className="w-full rounded-lg border border-gray-200 px-3.5 py-2.5 text-sm text-gray-900 outline-none transition-colors placeholder:text-gray-400 focus:border-[#0d7a72] focus:ring-2 focus:ring-[#0d7a72]/20"
                />
              </div>

              <div>
                <label htmlFor="lead-phone" className="mb-1.5 block text-sm font-medium text-gray-800">
                  Phone Number
                </label>
                <div className="flex gap-2">
                  <select
                    ...
                    className="w-[5.5rem] shrink-0 rounded-lg border border-gray-200 bg-white px-2 py-2.5 text-sm text-gray-900 outline-none focus:border-[#0d7a72] focus:ring-2 focus:ring-[#0d7a72]/20"
                  ...
                  <input
                    ...
                    className="min-w-0 flex-1 rounded-lg border border-gray-200 px-3.5 py-2.5 text-sm text-gray-900 outline-none transition-colors placeholder:text-gray-400 focus:border-[#0d7a72] focus:ring-2 focus:ring-[#0d7a72]/20"
                  />
                </div>
              </div>

              <div>
                <label htmlFor="lead-message" className="mb-1.5 block text-sm font-medium text-gray-800">
                  Message
                </label>
                <textarea
                  id="lead-message"
                  ...
                  className="w-full resize-none rounded-lg border border-gray-200 px-3.5 py-2.5 text-sm text-gray-900 outline-none transition-colors placeholder:text-gray-400 focus:border-[#0d7a72] focus:ring-2 focus:ring-[#0d7a72]/20"
                />
              </div>
              ...
              <label className="flex cursor-pointer items-center gap-2.5">
                <input
                  ...
                  className="size-4 rounded border-gray-300 text-[#0d7a72] focus:ring-[#0d7a72]/30"
                />
                <span className="text-sm font-medium text-[#0d7a72]">
