    ...
    <div className="group relative rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 aspect-[3/4]">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-xs bg-cta rounded-full px-2 py-0.5 font-semibold">
            {trek.difficulty}
          </span>
          <span className="text-xs text-white/70">{trek.location}</span>
        </div>
        <h3 className="font-bold text-base leading-tight group-hover:text-cta-muted transition-colors">
          {trek.title}
        </h3>
        ...
        <div className="flex items-center justify-between mt-3">
          <p className="font-bold text-cta-muted">{trek.price}/person</p>
